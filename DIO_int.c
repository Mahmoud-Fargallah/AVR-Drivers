 ...
 u8          DIO_enuGetPinValue(u8 Copy_u8PORTID, u8 Copy_u8PINID)
{
	...
	if( ( Copy_u8PORTID < 4 )&&( Copy_u8PINID < 8 ) )
	{
		switch( Copy_u8PORTID)
		{
			case PORTA: Local_u8Value = GET_BIT( DIO_PU8_PINA , Copy_u8PINID ); break;  /* <      *       *       *        > */
			case PORTB: Local_u8Value = GET_BIT( DIO_PU8_PINB , Copy_u8PINID ); break;  /*        Get Bin Value              */
			case PORTC: Local_u8Value = GET_BIT( DIO_PU8_PINC , Copy_u8PINID ); break;  /*                                   */
			case PORTD: Local_u8Value = GET_BIT( DIO_PU8_PIND , Copy_u8PINID ); break;  /* <      *       *       *        > */
		}
	}
